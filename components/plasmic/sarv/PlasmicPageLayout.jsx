...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: Q67Ne8sbyPn/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: WZo_QBMp6_4/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: Ik3k9xDPN7d/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__dVl2E)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
        const __composite = [{ path: null, name: null }];
        __composite["0"]["path"] = `/test`;
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__khFwC)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__inY9I)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__byueD)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__j1J6R)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
