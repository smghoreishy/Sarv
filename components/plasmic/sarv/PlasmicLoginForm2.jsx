...
import sty from "./PlasmicLoginForm2.module.css"; // plasmic-import: hUlJer5Oe3iN/css

createPlasmicElementProxy;

export const PlasmicLoginForm2__VariantProps = new Array(
  "empty",
  "phoneStandardCheck",
  "signupStepTwo",
  "loginStepTwo",
...
export const PlasmicLoginForm2__ArgProps = new Array(
  "onEmptyChange",
  "apiAnswer",
  "onApiAnswerChange",
...
function PlasmicLoginForm2__RenderFunc(props) {
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootloginStepTwo_signupStepTwoError]:
            hasVariant($state, "signupStepTwoError", "signupStepTwoError") &&
            hasVariant($state, "loginStepTwo", "loginStepTwo"),
          [sty.rootloginStepTwo_signupStepTwo]:
            hasVariant($state, "signupStepTwo", "signupStepTwo") &&
            hasVariant($state, "loginStepTwo", "loginStepTwo"),
    ...
    >
      ...
      <div
        className={classNames(
          ...
          sty.text__enV8K,
          {
            [sty.textloginStepTwoError__enV8KdAany]: hasVariant(
              $state,
              "loginStepTwoError",
              "loginStepTwoError"
            ),

            [sty.textloginStepTwo__enV8K6Ezwc]: hasVariant(
              $state,
              "loginStepTwo",
              "loginStepTwo"
            ),

            [sty.textsignupStepTwoError__enV8KiWAtj]: hasVariant(
              $state,
              "signupStepTwoError",
              "signupStepTwoError"
            ),

            [sty.textsignupStepTwo__enV8Kr9HGq]: hasVariant(
              $state,
              "signupStepTwo",
              "signupStepTwo"
            )
      ...
      {(
        ...
        <div
          className={classNames(
            ...
            sty.text__fnqb1,
            {
              [sty.textloginStepTwoError__fnqb1DAany]: hasVariant(
                $state,
                "loginStepTwoError",
                "loginStepTwoError"
              ),

              [sty.textloginStepTwo__fnqb16Ezwc]: hasVariant(
                $state,
                "loginStepTwo",
                "loginStepTwo"
              ),

              [sty.textsignupStepTwoError__fnqb1IWAtj]: hasVariant(
                $state,
                "signupStepTwoError",
                "signupStepTwoError"
              ),

              [sty.textsignupStepTwo__fnqb1R9HGq]: hasVariant(
                $state,
                "signupStepTwo",
                "signupStepTwo"
              )
      ...
      {(
        ...
        <div
          className={classNames(
            ...
            sty.text__xQkhs,
            {
              [sty.textloginStepTwoError__xQkhSdAany]: hasVariant(
                $state,
                "loginStepTwoError",
                "loginStepTwoError"
              ),

              [sty.textloginStepTwo__xQkhs6Ezwc]: hasVariant(
                $state,
                "loginStepTwo",
                "loginStepTwo"
              ),

              [sty.textsignupStepTwoError__xQkhSiWAtj]: hasVariant(
                $state,
                "signupStepTwoError",
                "signupStepTwoError"
              ),

              [sty.textsignupStepTwo__xQkhSr9HGq]: hasVariant(
                $state,
                "signupStepTwo",
                "signupStepTwo"
              )
      ...
      {(
        ...
        <div
          className={classNames(
            ...
            sty.text__oodDg,
            {
              [sty.textloginStepTwoError__oodDgdAany]: hasVariant(
                $state,
                "loginStepTwoError",
                "loginStepTwoError"
              ),

              [sty.textloginStepTwo__oodDg6Ezwc]: hasVariant(
                $state,
                "loginStepTwo",
                "loginStepTwo"
              ),

              [sty.textsignupStepTwoError__oodDgiWAtj]: hasVariant(
                $state,
                "signupStepTwoError",
                "signupStepTwoError"
              ),

              [sty.textsignupStepTwo__oodDgr9HGq]: hasVariant(
                $state,
                "signupStepTwo",
                "signupStepTwo"
              )
      ...
      {(() => {
        const child$Props = {
          className: classNames("__wab_instance", sty.token, {
            [sty.tokenempty]: hasVariant($state, "empty", "empty"),
            ...
            [sty.tokenphoneStandardCheck]: hasVariant(
              $state,
              "phoneStandardCheck",
              "phoneStandardCheck"
            ),
      ...
      <div
        className={classNames(
          ...
          sty.text__geNq,
          {
            [sty.textloginStepTwoError__geNqdAany]: hasVariant(
              $state,
              "loginStepTwoError",
              "loginStepTwoError"
            ),

            [sty.textsignupStepTwoError__geNqiWAtj]: hasVariant(
              $state,
              "signupStepTwoError",
              "signupStepTwoError"
            )
                      ...
                      customFunction: __wrapUserFunction(
                        {
                          ...
                          interactionUuid: "N7W-VFeWLrI8",
                          componentUuid: "hUlJer5Oe3iN",
      ...
      <div
        className={classNames(
          ...
          sty.text__qd6Vi,
          {
            [sty.textempty__qd6Viuibul]: hasVariant($state, "empty", "empty"),
            [sty.textphoneStandardCheck__qd6ViCusB1]: hasVariant(
              $state,
              "phoneStandardCheck",
              "phoneStandardCheck"
            ),

            [sty.textphoneStandardCheck_signupStepTwoError__qd6ViCusB1IWAtj]:
              hasVariant($state, "phoneStandardCheck", "phoneStandardCheck") &&
              hasVariant($state, "signupStepTwoError", "signupStepTwoError"),
            [sty.textphoneStandardCheck_signupStepTwo__qd6ViCusB1R9HGq]:
              hasVariant($state, "phoneStandardCheck", "phoneStandardCheck") &&
              hasVariant($state, "signupStepTwo", "signupStepTwo"),
            [sty.textsignupStepTwoError__qd6ViiWAtj]: hasVariant(
              $state,
              "signupStepTwoError",
              "signupStepTwoError"
            ),

            [sty.textsignupStepTwoError_empty__qd6ViiWAtjUibul]:
              hasVariant($state, "signupStepTwoError", "signupStepTwoError") &&
              hasVariant($state, "empty", "empty"),
            [sty.textsignupStepTwo__qd6Vir9HGq]: hasVariant(
              $state,
              "signupStepTwo",
              "signupStepTwo"
            ),

            [sty.textsignupStepTwo_empty__qd6Vir9HGqUibul]:
              hasVariant($state, "signupStepTwo", "signupStepTwo") &&
              hasVariant($state, "empty", "empty")
          }
        )}
      ...
      {(
        ...
        <div
          className={classNames(
            ...
            sty.text__lZbn9,
            {
              [sty.textempty__lZbn9Uibul]: hasVariant($state, "empty", "empty"),
              [sty.textphoneStandardCheck__lZbn9CusB1]: hasVariant(
                $state,
                "phoneStandardCheck",
                "phoneStandardCheck"
              ),

              [sty.textphoneStandardCheck_empty__lZbn9CusB1Uibul]:
                hasVariant($state, "empty", "empty") &&
                hasVariant($state, "phoneStandardCheck", "phoneStandardCheck"),
              [sty.textphoneStandardCheck_signupStepTwoError__lZbn9CusB1IWAtj]:
                hasVariant(
                  $state,
                  "phoneStandardCheck",
                  "phoneStandardCheck"
                ...
                hasVariant($state, "signupStepTwoError", "signupStepTwoError"),
              [sty.textphoneStandardCheck_signupStepTwo__lZbn9CusB1R9HGq]:
                hasVariant(
                  $state,
                  "phoneStandardCheck",
                  "phoneStandardCheck"
                ) && hasVariant($state, "signupStepTwo", "signupStepTwo"),
              [sty.textsignupStepTwoError__lZbn9IWAtj]: hasVariant(
                $state,
                "signupStepTwoError",
                "signupStepTwoError"
              ),

              [sty.textsignupStepTwoError_empty__lZbn9IWAtjUibul]:
                hasVariant(
                  $state,
                  "signupStepTwoError",
                  "signupStepTwoError"
                ) && hasVariant($state, "empty", "empty"),
              [sty.textsignupStepTwo__lZbn9R9HGq]: hasVariant(
                $state,
                "signupStepTwo",
                "signupStepTwo"
              ),

              [sty.textsignupStepTwo_empty__lZbn9R9HGqUibul]:
                hasVariant($state, "signupStepTwo", "signupStepTwo") &&
                hasVariant($state, "empty", "empty")
            }
          )}
                  ...
                  customFunction: __wrapUserFunction(
                    ...
                    () => async () => {
                      return (() => {
                        const axios = require("axios");
                        const webhookUrl =
                          "https://n8n.bot.inbeet.tech/webhook-test/2c4d1876-b44e-456e-8079-edf2ac1fe616";
                        const queryParams = {
                          phone_number: $state.phone.value,
                        ...
                        return axios
                          ...
                          .then(response => {
                            ...
                            $state.browserToken = String(response.data["data"]);
                            $state.tokenAnswer = String(
                              response.data["state-answer"]
                            );
                          })
                          .catch(error => {
                            console.error("Error calling webhook:", error);
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicLoginForm2__ArgProps,
          internalVariantPropNames: PlasmicLoginForm2__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicLoginForm2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicLoginForm2";
  } else {
    func.displayName = `PlasmicLoginForm2.${nodeName}`;
  }
  return func;
}

export const PlasmicLoginForm2 = Object.assign(
  // Top-level PlasmicLoginForm2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicLoginForm2
    internalVariantProps: PlasmicLoginForm2__VariantProps,
    internalArgProps: PlasmicLoginForm2__ArgProps
  }
);

export default PlasmicLoginForm2;
/* prettier-ignore-end */
