...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 125Bsk5icPhZ/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchIcon
              className={classNames(projectcss.all, sty.svg__xo1Hu)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <CheckIcon
              className={classNames(projectcss.all, sty.svg__qRiik)}
              role={"img"}
            />
          ),
