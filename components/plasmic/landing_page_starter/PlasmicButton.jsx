...
import sty from "./PlasmicButton.module.css"; // plasmic-import: LI4MGYb9rz-K/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__ndvcu)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__hWYcg)}
                role={"img"}
              />
            ),
